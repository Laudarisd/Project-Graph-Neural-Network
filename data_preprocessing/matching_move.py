    ...
    def classify_images(self):
        for filename in os.listdir(self.cropped_folder):
            if filename.endswith('.PNG'):
                ...
                if orientation is not None and match_score > 0.8:  # Adjust the threshold as needed
...
template_folders = {
    'case-1': './class_data/junc_I_undefined_cases/case-1',
    'case-2': './class_data/junc_I_undefined_cases/case-2',
    'case-3': './class_data/junc_I_undefined_cases/case-3',
    'case-4': './class_data/junc_I_undefined_cases/case-4'
}
